...
export const authSendPhoneNumber = ({ phoneNumber }) => apiRequest(Object.assign({}, { verb: 'POST', route: `https://automate.bloo.financial/api/login`, body: { phoneNumber } }))
export const authSendCode = ({ phoneNumber, code }) => apiRequest(Object.assign({}, { verb: 'POST', route: `https://automate.bloo.financial/api/login`, body: { phoneNumber, code } }))
export const getUser = ({ accessToken }) => apiRequest(Object.assign({}, { verb: 'POST', route: `https://automate.bloo.financial/api/user`, headers: { 'Access-Token': accessToken } }))

export const getUserLocalStorage = () => {
  retrieveStoredValue( 'local', 'user' )
}
